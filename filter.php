...
if($category == 0){
  ...
  $category_id = $row1['id'];
  if($gia == 1)
    $sql = "SELECT * FROM sanpham WHERE category_id = '$category_id' and GiaSP >= 5000000 and GiaSP <= 15000000";
  else if($gia == 2)
    $sql = "SELECT * FROM sanpham WHERE category_id = '$category_id' and GiaSP >= 15000000 and GiaSP <= 20000000";
  else if($gia == 3)
    $sql = "SELECT * FROM sanpham WHERE category_id = '$category_id' and GiaSP >= 20000000";
  else
